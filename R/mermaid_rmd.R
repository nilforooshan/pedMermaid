...
#'
#' @details
#' The Mermaid syntax generated by the \code{\link{mermaid}} function can be embeded in Markdown files and Markdown renderes such as GitHub, but not in R Markdown.
...
mermaid_rmd <- function(ped, orient = "TB", type = "arrow", outfile = "") {
    ...
    # Write node.lines
    ## Discard ped rows with both parents missing
    ...
    node.lines <- paste(node.lines$parentnode, node.lines$childnode, sep = type)
    ## Indent
